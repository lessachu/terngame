...
func register(w http.ResponseWriter, r *http.Request) {
	...
	msg := &mail.Message{
		Sender:  "lahosken@gmail.com",
		To:      emailList,
		Subject: "Confirm your registration",
		Body: fmt.Sprintf(`
Thank you for creating an account on ternga.me!

Your team name is: %s
Your password is: %s 

Login at http://www.ternga.me/loginprompt?team=%s    

# # # Have fun! # # #

(You can send comments, typo reports, etc.
to this lahosken@gmail.com address.)
...
func resetpassword(w http.ResponseWriter, r *http.Request) {
	...
	msg := &mail.Message{ // TODO this will change a lot
		...
		Body: fmt.Sprintf(`
    Thank you for resetting a password on ternga.me!
